...
You can also shout-out multiple channels like: **!so MrCoolStreamer WillStreamForBeer RetroGamer GamerGamingGames**. This will iterate over the list and do a shout-out every timeOut=value(seconds). 
